...
/* Esta função estabelece uma ligação ao servidor seguinte, envia uma mensagem, recebe a resposta e depois disconecta-se
 * Retorna 0 (OK) ou -1 em caso de erro.
 */
int send_next(MessageT *message);

/* Esta função liberta a memória anterior, atribui nova memória para o endereço do servidor seguinte e copia o novo endereço, se fornecido.
 */
