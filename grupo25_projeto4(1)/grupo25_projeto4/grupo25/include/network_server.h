...
/* Esta função é responsável por receber pedidos de um cliente, invocar a operação correspondente, enviar a resposta,
 * e tratar os erros no processo.
 * Retorna -1 em caso de erro ou quando a conexão do cliente é fechada.
 */
